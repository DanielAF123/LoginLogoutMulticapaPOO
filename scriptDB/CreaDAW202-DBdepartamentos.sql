...
-- Crear base de datos --
    CREATE DATABASE if NOT EXISTS DAW202DBLoginLogoff;
...
-- Crear tablas. --
    ...
    CREATE TABLE IF NOT EXISTS Usuario(
        ...
        NumConexiones INTEGER(10) default 0,
...
-- Crear del usuario --
    CREATE USER IF NOT EXISTS 'usuarioDAW202DBLoginLogoff'@'%' identified BY 'paso'; 

-- Dar permisos al usuario --
    GRANT ALL PRIVILEGES ON DAW202DBLoginLogoff.* TO 'usuarioDAW202DBLoginLogoff'@'%'; 
